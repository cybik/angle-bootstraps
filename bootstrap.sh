...
git apply -v $BUILDROOT/patches/0001-HACK-Force-__ggp__-define.patch
git -C third_party/vulkan-loader/src apply -v $BUILDROOT/patches/0001-HACK-Stub-GGP-functions.patch
git -C third_party/vulkan-headers/src apply -v $BUILDROOT/patches/0001-GN-Make-PLATFORM_XCB-optional-based-on-a-user-define.patch
